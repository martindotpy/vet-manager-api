...
public class GetSaleAppointmentIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    void noUser_GetSaleAppointmentWithValidParams_Forbidden() throws Exception {
    ...
    @Test
    void noUser_GetSaleAppointmentWithInvalidParams_ID_Forbidden() throws Exception {
    ...
    @Test
    void noUser_GetSaleAppointmentWithInvalidParams_ID_Negative_Forbidden() throws Exception {
        mockMvc.perform(get("/sale/{id}", -10))
                .andExpect(status().isForbidden())
                .andExpect(jsonPath("$.message").value(MESSAGE_FORBIDDEN));
    }
    ...
    @Test
    void noUser_GetSaleAppointmentWithInvalidParams_ID_NotNumber_Forbidden() throws Exception {
    ...
    // Role: USER
    @Test
    void user_GetSaleAppointmentWithValidParams_Ok() throws Exception {
        mockMvc.perform(get("/sale/{id}", 1)
                ...
                .andExpectAll(
                        ...
                        jsonPath("$.content.appointment").isMap());
    }

    @Test
    void user_GetSaleAppointmentWithInvalidParams_ID_NotFound() throws Exception {
        mockMvc.perform(get("/sale/{id}", 10)
                .header("Authorization", BEARER_USER_JWT))
    ...
    @Test
    void user_GetSaleAppointmentWithInvalidParams_ID_Negative_UnprocessableEntity() throws Exception {
        mockMvc.perform(get("/sale/{id}", -10)
                .header("Authorization", BEARER_USER_JWT))
    ...
    @Test
    void user_GetSaleAppointmentWithInvalidParams_ID_NotNumber_UnprocessableEntity() throws Exception {
        mockMvc.perform(get("/sale/{id}", "abcde")
                .header("Authorization", BEARER_USER_JWT))
                .andExpect(status().isUnprocessableEntity())
                .andExpectAll(
