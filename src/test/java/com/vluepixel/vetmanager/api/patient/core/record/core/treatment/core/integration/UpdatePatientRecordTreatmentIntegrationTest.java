...
public class UpdatePatientRecordTreatmentIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithValidArguments_Forbidden() throws Exception {
    ...
    // Patient ID
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_Forbidden() throws Exception {
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_Negative_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", -10, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST)))
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_NotNumber_Forbidden()
            throws Exception {
    ...
    // Record ID
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_Forbidden() throws Exception {
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_Negative_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, -10)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST)))
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_NotNumber_Forbidden()
            throws Exception {
    ...
    // Treatment ID
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_Forbidden() throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_Negative_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_Null_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    // Description
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Blank_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Empty_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Null_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    // Order
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Negative_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Zero_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void noUser_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Null_Forbidden()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    @DirtiesContext
    void user_UpdatePatientRecordTreatmentWithValidArguments_Ok() throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    // Patient ID
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_NotFound() throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 10, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
                .header("Authorization", BEARER_USER_JWT))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_Negative_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", -10, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_PatientID_NotNumber_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", "abcde", 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    @Test
    @DirtiesContext
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_NotFound() throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 10)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
                .header("Authorization", BEARER_USER_JWT))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_Negative_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, -10)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_RecordID_NotNumber_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, "abcde")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(VALID_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    // Treatment ID
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_NotFound() throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(INVALID_ID_NOT_FOUND_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
                .header("Authorization", BEARER_USER_JWT))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_Negative_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(INVALID_ID_NEGATIVE_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_TreatmentID_Null_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(INVALID_ID_NULL_UPDATE_PATIENT_RECORD_TREATMENT_REQUEST))
    ...
    // Description
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Blank_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Empty_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Description_Null_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    // Order
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Negative_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Zero_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
    ...
    @Test
    void user_UpdatePatientRecordTreatmentWithInvalidArguments_Order_Null_UnprocessableEntity()
            throws Exception {
        mockMvc.perform(put("/patient/{patient_id}/record/{record_id}/treatment", 1, 1)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper
